 ...
 * generated in the module.webservice.services.example2.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetTeamsResponse_QNAME = new QName("http://example2.services.webservice.module/", "getTeamsResponse");
    private final static QName _GetTeam_QNAME = new QName("http://example2.services.webservice.module/", "getTeam");
    private final static QName _GetTeams_QNAME = new QName("http://example2.services.webservice.module/", "getTeams");
    private final static QName _GetTeamResponse_QNAME = new QName("http://example2.services.webservice.module/", "getTeamResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: module.webservice.services.example2.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example2.services.webservice.module/", name = "getTeamsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example2.services.webservice.module/", name = "getTeam")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example2.services.webservice.module/", name = "getTeams")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example2.services.webservice.module/", name = "getTeamResponse")
